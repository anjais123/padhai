...
jQuery(document).ready(function () {
   ...
   window.FPConfig = {
    ...
    $(this).parent().find('.carosel-item' + i).addClass('hide');
    $(this).parent().find('.carosel-item' + i).removeClass('show');
    $(this).parent().find('.carosel-item' + (i+1)%7).removeClass('hide');
    $(this).parent().find('.carosel-item' + (i+1)%7).addClass('show');
    //$(this).parent().find('.carosel-item' + i).insertAfter($(this).parent().find('.carosel-item'+(i+1)%8));
    i=(i+1)%7;
  });
  $('.carosel-control-left').click(function() {
    $(this).parent().find('.carosel-item' + i).addClass('hide');
    $(this).parent().find('.carosel-item' + i).removeClass('show');
    $(this).parent().find('.carosel-item' + (i-1+7)%7).removeClass('hide');
    $(this).parent().find('.carosel-item' + (i-1+7)%7).addClass('show');
   // $(this).parent().find('.carosel-item'+(i)%8).insertBefore($(this).parent().find('.carosel-item' + (i-1+8)%8));
    i = (i-1 +7)%7;
  });
